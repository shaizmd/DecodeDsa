...
export default function Page() {
  const categories = [
    ...
    },
    {
      ...
      description:
        "Explore various search techniques and their implementations",
      icon: Search,
    ...
    },
    {
      ...
      description:
        "Visualize two pointer, three pointer, and sliding window techniques",
      icon: Target,
      ...
      algorithms: [
        {
          ...
          description:
            "Two Pointer, Three Pointer, Sliding Window step-by-step visualization",
        },
      ],
    },
    {
      ...
      description:
        "Learn fundamental data structures with interactive examples",
      icon: Database,
        ...
        <div className="relative container mx-auto px-4 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
              Visualize, understand, and master fundamental computer science
              concepts through interactive animations and step-by-step
              explanations.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/sorting"
                className="inline-flex justify-center items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
              ...
              <button className="inline-flex justify-center items-center px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all duration-200">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Experience the most intuitive way to learn algorithms and data
              structures
            </p>
          </div>
      ...
      <div className="py-16 bg-gradient-to-br from-slate-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose from our comprehensive collection of algorithms and data
              structures
            </p>
          </div>
            ...
            {categories.map((category, index) => (
              <div key={category.title} className="group">
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-gray-200 transform hover:-translate-y-2">
                  {/* Category Header */}
                  <div
                    className={`h-32 bg-gradient-to-r ${category.color} relative overflow-hidden`}
                  >
      ...
      <div className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of students and professionals who have mastered
